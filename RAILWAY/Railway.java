...
class Admin {
    ...
    static int col = 1;
    static int row = 5;
    static ArrayList<ArrayList<ArrayList<String>>> Train = new ArrayList<>(col);
...
class User {
    ...
    static void bookTickets() {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (Available) {
                printTrain(Integer.parseInt(idBook) - 1);
                System.out.println();
